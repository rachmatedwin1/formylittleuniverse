...
`).join('');
    ...
    prepareCompleteSettings(settingsToUse) {
        ...
        const completeSettings = {
            ...
            sequence: settingsToUse.sequence || 'HAPPY|BIRTHDAY|MY|CUTIE|LITTLE|UNIVERSE|❤',
    ...
    getCurrentSettingsFromModal() {
        ...
        try {
            ...
            const modalSettings = {
                ...
                sequence: document.getElementById('sequenceText')?.value || 'HAPPY|BIRTHDAY|MY|CUTIE|LITTLE|UNIVERSE|❤',
